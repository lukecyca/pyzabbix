...
parser.add_argument('-u', dest='username', default='Admin', required=True,
                   help='zabbix username, default Admin')
parser.add_argument('-p', dest='password', default='zabbix', required=True,
                   help='zabbix password')
parser.add_argument('-k', dest='key',default='', required=True,
